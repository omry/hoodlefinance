...
- Prefer the GitHub Actions release flow when the task is about an actual release cut: `Release Prepare`, then `Release Publish`, with `Demo Sync On Release` triggered from the published release.
