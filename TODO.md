...
- Optimize `attribute@<currency>` conversion for large array inputs by deduping repeated source-to-target unit resolutions and FX conversion-pair lookups within a recalculation pass.
