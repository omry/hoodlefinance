...
> Archived note: this document describes an earlier structural DAG-instantiation path. For the current graph/runtime shape, see [`final-dag-shape-redesign.md`](./final-dag-shape-redesign.md).
