...
> Archived note: this document describes an earlier routing graph design. For the current graph/runtime shape, see [`final-dag-shape-redesign.md`](./final-dag-shape-redesign.md).
